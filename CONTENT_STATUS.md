...
| 8  | ~56 (planned) | — | ✅ | ✅ | 🔄 | ❌ | ❌ | ❌ | ❌ | ❌ | 🔄 | ❌ | 🔄 | **IN PROGRESS (2026-06-03):** NCERT Class 8 (AP SSC SEM-1 Ch1–8 + SEM-2 Ch9–16). topicId prefix `ap_ssc_math8_*`, board AP_SSC, grade 8. **Ph1 ✅** 16 NcertChapter skeletons (`seedApSscMath8NcertChapters.js`). **Ph2 🔄** teaching content — **Ch1 Rational Numbers done (4 topics, 13/13 content fields pass `audit:math --prefix=ap_ssc_math8_`)**; Ch2–16 pending. Then Ph3 Qs A/B/C, Ph5 DAG, Ph6 RAG, Ph4 diagrams. |
