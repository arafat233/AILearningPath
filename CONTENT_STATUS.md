...
| 6  | 40 | ~660  | ✅ | ✅ | ✅ | ✅ | —  | ✅ | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | **v3 enrichment IN PROGRESS (2026-06-02):** `enrichMath6.js` (`npm run enrich:math6`) patches the 7 audit fields onto math6_* docs, grounded in Ganita Prakash Grade 6 PDFs. **Ch1–6 done → 24/40 pass 15/15.** Ch7–10 pending. Ph5=40-node topic-level DAG; Ph6=40 RAG chunks; Ph9=NcertTopicView wired 2026-05-23 |
| 5  | 56 | ~600  | ✅ | ✅ | ✅ | ✅ | —  | ✅ | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | v2 format; **Ph5=56-node topic-level DAG** (`seedMathPrimaryTopicDAG.js --grade=5`, 2026-06-02); Ph6=56 RAG chunks; Ph8=8/15 (v2 gap); Ph9=NcertTopicView wired 2026-05-23 |
| 4  | 56 | ~540  | ✅ | ✅ | ✅ | ✅ | —  | ✅ | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | v2 format; **Ph5=56-node topic-level DAG** (`seedMathPrimaryTopicDAG.js --grade=4`, 2026-06-02); Ph6=56 RAG chunks; Ph8=8/15 (v2 gap); Ph9=NcertTopicView wired 2026-05-23 |
| 3  | 56 | ~480  | ✅ | ✅ | ✅ | ✅ | —  | ✅ | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | v2 format; **Ph5=56-node topic-level DAG** (`seedMathPrimaryTopicDAG.js --grade=3`, 2026-06-02); Ph6=56 RAG chunks; Ph8=8/15 (v2 gap); Ph9=NcertTopicView wired 2026-05-23 |
