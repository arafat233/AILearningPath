...
| 8  | 56 | — | ✅ | ✅ | 🔄 | ❌ | ❌ | ❌ | ❌ | ❌ | 🔄 | ❌ | 🔄 | **IN PROGRESS (2026-06-03):** NCERT Class 8 (AP SSC SEM-1 Ch1–8 + SEM-2 Ch9–16). topicId prefix `ap_ssc_math8_*`, board AP_SSC, grade 8. **Ph1 ✅** 16 NcertChapter skeletons (`seedApSscMath8NcertChapters.js`). **Ph2 🔄** teaching content — **Ph2 CONTENT COMPLETE: all 16 chapters / 56 topics pass 13/13 content fields.** Ph3 Questions + Ph6 RAG pending (content-first plan). Then Ph3 Qs A/B/C, Ph5 DAG, Ph6 RAG, Ph4 diagrams. |
