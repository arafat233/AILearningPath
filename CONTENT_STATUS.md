...
| 8  | 56 | 280 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ✅ | ❌ | ✅ | **AUDIT 56/56 PASS (2026-06-03):** NCERT Class 8 (AP SSC SEM-1 Ch1–8 + SEM-2 Ch9–16). topicId prefix `ap_ssc_math8_*`, board AP_SSC, grade 8. 16 NcertChapter skeletons (`seedApSscMath8NcertChapters.js`). **Ph2 ✅** 56 topics full 15-field content. **Ph3 ✅** 280 MCQ (`seedApSscMath8QuestionsCh01–16.js`). **Ph6 RAG ✅** (265 chunks). **Every topic clears all 15 audit checks.** Remaining (optional): Ph4 dedicated diagrams, Ph5 topic DAG, Ph7/Ph9. |
