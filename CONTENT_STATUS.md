...
| 6  | 40 | ~660  | ✅ | ✅ | ✅ | ✅ | —  | ✅ | ✅ | ✅ | ⚠️ | ✅ | ⚠️ | **v3 enrichment IN PROGRESS (2026-06-02):** `enrichMath6.js` (`npm run enrich:math6`) patches the 7 audit fields onto math6_* docs, grounded in Ganita Prakash Grade 6 PDFs. **Ch1–4 done → 16/40 pass 15/15.** Ch5–10 pending. Ph5=40-node topic-level DAG; Ph6=40 RAG chunks; Ph9=NcertTopicView wired 2026-05-23 |
