...
| 1  | 52 | ~360  | ✅ | ✅ | ✅ | ✅ | —  | ✅ | ✅ | ✅ | 🔄 | ✅ | 🔄 | **v3 enrichment IN PROGRESS (2026-06-02):** `enrichMath1.js` (`npm run enrich:math1`) patches the 7 audit fields onto math1_* docs (Joyful Mathematics Grade 1, aejm101-113). **Ch1-7 done → 28/52 pass 15/15.** Ch8-13 pending. Ph5=52-node topic-level DAG; Ph6=52 RAG chunks; Ph9=NcertTopicView wired 2026-05-23 |
