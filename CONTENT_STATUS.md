...
| 7  | 60 | ~810  | ✅ | ✅ | ✅ | ✅ | ⚠️ | ⚠️ | ✅ | ✅ | 🔄 | ✅ | 🔄 | **v3 enrichment IN PROGRESS (2026-06-02):** `config/enrichMath7.js` (`npm run enrich:math7`) patches the 7 missing audit fields (key_formulas, prerequisite_knowledge, visual_description, svg_diagrams, when_to_use_this_method, edge_cases, video_script_hooks) onto the 60 `math7_*` v2 docs in place — grounded in Ganita Prakash Grade 7 PDFs. **Ch1–13 done → 52/60 pass 15/15.** Ch14–15 pending. Ph6=60 RAG chunks; 555 Qs. |
