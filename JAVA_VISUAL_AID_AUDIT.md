...
- [x] ✅(fixed) **java_m9_t5** — Generic Interfaces & Design Patterns
  - req: `TREE` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m10_t3** — ExecutorService and Thread Pools
  - req: `STATE` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m11_t1** — NIO File API
...
- [x] ✅(fixed) **java_m11_t2** — Buffered I/O and Character Streams
  - req: `MEMORY` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m11_t3** — CSV and Structured Data Processing
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m11_t4** — Java HttpClient
  - req: `STATE` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m12_t1** — JUnit 5 Basics
...
- [x] ✅(fixed) **java_m12_t4** — Testing I/O and HTTP
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m12_t5** — Test-Driven Development (TDD)
  - req: `STATE` · now: `auto-FLOW`
...
- [x] ✅(fixed) **java_m13_t1** — Spring Boot Introduction
  - req: `TREE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m13_t4** — Validation and Exception Handling
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m14_t3** — Spring Cache with @Cacheable
...
- [x] ✅(fixed) **java_m14_t5** — Actuator and Production Observability
  - req: `TREE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m15_t2** — Feign Client
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m16_t1** — Introduction to Apache Kafka
  - req: `MEMORY` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m17_t2** — The N+1 Query Problem
  - req: `TREE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m17_t3** — Connection Pooling & Query Optimization
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m17_t4** — JPA Advanced Relationships
  - req: `TABLE/GRID` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m18_t2** — Cache-Aside Pattern & Advanced Strategies
  - req: `MEMORY` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m18_t4** — Redis Distributed Locks
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m20_t4** — Prometheus & Grafana Dashboards
...
- [x] ✅(fixed) **java_m22_t1** — JVM Tuning & Garbage Collection
...
- [x] ✅(fixed) **java_m22_t2** — Database Query Optimization
  - req: `TREE` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m22_t4** — Caching Strategies (L1 + L2)
  - req: `TREE` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m24_t2** — Event Sourcing
  - req: `STATE` · now: `svg-PANELS(text-in-boxes)`
...
- [x] ✅(fixed) **java_m25_t1** — Testcontainers — Real Dependencies in Tests
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m25_t2** — Contract Testing with Pact
  - req: `STATE` · now: `auto-PANELS`
...
- [x] ✅(fixed) **java_m25_t5** — Chaos Engineering
  - req: `STATE` · now: `svg-PANELS(text-in-boxes)`
