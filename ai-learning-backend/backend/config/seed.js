...
await Topic.insertMany([
  { name:"Real Numbers",                 subject:"Math", grade:"10", prerequisites:[],                                                        examFrequency:0.85, estimatedHours:2 },
  { name:"Polynomials",                  subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.8,  estimatedHours:2 },
  { name:"Linear Equations",             subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.85, estimatedHours:3 },
  { name:"Quadratic Equations",          subject:"Math", grade:"10", prerequisites:["Linear Equations","Algebra Basics"],                     examFrequency:0.9,  estimatedHours:4 },
  { name:"Arithmetic Progressions",      subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.85, estimatedHours:3 },
  { name:"Triangles",                    subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.8,  estimatedHours:3 },
  { name:"Coordinate Geometry",          subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.75, estimatedHours:3 },
  { name:"Trigonometry",                 subject:"Math", grade:"10", prerequisites:["Algebra Basics","Triangles"],                            examFrequency:0.9,  estimatedHours:4 },
  { name:"Applications of Trigonometry", subject:"Math", grade:"10", prerequisites:["Trigonometry"],                                          examFrequency:0.8,  estimatedHours:3 },
  { name:"Circles",                      subject:"Math", grade:"10", prerequisites:["Triangles"],                                             examFrequency:0.75, estimatedHours:3 },
  { name:"Surface Areas & Volumes",      subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.85, estimatedHours:4 },
  { name:"Statistics",                   subject:"Math", grade:"10", prerequisites:["Algebra Basics"],                                        examFrequency:0.8,  estimatedHours:3 },
  { name:"Probability",                  subject:"Math", grade:"10", prerequisites:[],                                                        examFrequency:0.7,  estimatedHours:2 },
  { name:"Areas Related to Circles",     subject:"Math", grade:"10", prerequisites:["Circles","Trigonometry"],                               examFrequency:0.7,  estimatedHours:2 },
  { name:"Algebra Basics",               subject:"Math", grade:"10", prerequisites:[],                                                        examFrequency:0.95, estimatedHours:2 },
]);
