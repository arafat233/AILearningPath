...
/* Presentational component — all state + handlers passed as props */
export default function VoiceTutorView({
  subject, isHindi, isSupported, chat, text, topic, listening, speaking, speakingIdx,
  loading, historyLoading, status, error, listenSecs, followUps, savedIdx, weakTopics,
  summaryOpen, limitReached, user, quickPrompts, exchanges, sessionCovered, showSummary,
  setText, setTopic, handleClearHistory, startListening, stopListening, speak, stopSpeaking,
  sendMessage, handleSaveNote, setSummaryOpen,
}) {
  ...
  return (
    <div className="w-full space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-[11px] font-bold tracking-[0.18em] uppercase text-[#8e8e93] mb-1">Stellar · Voice Tutor</p>
