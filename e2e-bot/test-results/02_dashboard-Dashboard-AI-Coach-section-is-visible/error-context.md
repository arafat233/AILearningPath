...
- Name: 02_dashboard.spec.js >> Dashboard >> AI Coach section is visible
- Location: tests\02_dashboard.spec.js:55:3
...
Call log:
  ...
  - waiting for locator('text=AI Coach')
