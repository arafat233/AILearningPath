...
- Name: 02_dashboard.spec.js >> Dashboard >> Topics section heading is visible
- Location: tests\02_dashboard.spec.js:39:3
...
Locator: getByText('Topics', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Topics', { exact: true })
