...
- Name: 02_dashboard.spec.js >> Dashboard >> four stat cards are visible (Accuracy, Questions, Weak, Strong)
- Location: tests\02_dashboard.spec.js:23:3
...
Locator: locator('text=Overall Accuracy')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Overall Accuracy')
