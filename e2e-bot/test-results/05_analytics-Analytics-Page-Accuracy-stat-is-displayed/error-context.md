...
- Name: 05_analytics.spec.js >> Analytics Page >> Accuracy stat is displayed
- Location: tests\05_analytics.spec.js:26:3
...
Call log:
  ...
  - waiting for locator('text=Accuracy, text=Overall, text=Score').first()
