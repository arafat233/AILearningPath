...
- Name: 07_profile.spec.js >> Profile Page >> avatar / user name is visible
- Location: tests\07_profile.spec.js:20:3
...
Call log:
  ...
  - waiting for [class*="rounded-full"], text=Test Bot >> nth=0
