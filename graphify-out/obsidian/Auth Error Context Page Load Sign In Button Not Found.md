...
## Connections
- [[Auth Feature]] - `references` [EXTRACTED]
- [[Error button type submit not found in DOM]] - `references` [EXTRACTED]
- [[Page login]] - `references` [EXTRACTED]
- [[Root Issue Login Submit button lacks type=submit attribute]] - `rationale_for` [EXTRACTED]
