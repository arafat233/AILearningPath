...
## Connections
- [[Auth Error Context Invalid Credentials Stay on Login]] - `rationale_for` [INFERRED]
- [[Auth Error Context Page Load Sign In Button Not Found]] - `rationale_for` [EXTRACTED]
- [[Error TimeoutError page.click exceeded 20000ms]] - `rationale_for` [INFERRED]
