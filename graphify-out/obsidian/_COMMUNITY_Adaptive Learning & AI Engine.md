...
```dataview
TABLE source_file, type FROM #community/Adaptive_Learning_&_AI_Engine
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Admin & AI Controllers]]
- 3 edges to [[_COMMUNITY_Exam & Scoring Services]]
- 2 edges to [[_COMMUNITY_Analysis & Auth Controllers]]
...
- [[sessionSet()]] - degree 4, connects to 1 community